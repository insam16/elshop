...
import { requestCommentDeletion, type CommentDeleteRequestState } from "@/lib/actions/report";

export default function CommentDeleteRequestModal({
  commentId,
  type = "댓글",
}: {
  commentId: string;
  ...
  const [state, formAction, isPending] = useActionState<CommentDeleteRequestState, FormData>(
    ...
    <>
      ...
      >
        <div className="page-header">
          <h2 className="text-base font-bold">{type} 삭제 요청</h2>
          <button
