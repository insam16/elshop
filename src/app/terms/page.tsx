...
export default function TermsPage() {
  return (
    <div className="max-w-2xl mx-auto">
      <PolicyLayout title="이용약관" effectiveDate="2026년 4월 18일">
        <Section title="제1조 목적">
          <p>
            본 약관은 엘샵(이하 "서비스")이 제공하는 엘소드 아이템 거래 게시판 서비스의
        ...
        <Section title="제3조 금지 행위">
          ...
          <ul>
            ...
            <li>현금 거래 유도 등 불법적 거래 알선</li>
            <li>동일 게시글 반복 도배</li>
          </ul>
        </Section>

        <Section title="제4조 게시물">
          <ul>
